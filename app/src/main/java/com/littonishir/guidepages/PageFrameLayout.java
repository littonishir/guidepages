...
public class PageFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
     ...
     * @param layoutIds
     */
    public void setUpViews(MainActivity mainActivity, int[] layoutIds, int dot_on, int dot_off) {
        this.dot_on = dot_on;
        ...
        dot_ll.setBackgroundResource(R.color.transparent);
        ...
        viewPager.setAdapter(new PageFragmentAdapter(mainActivity.getSupportFragmentManager(), fragments));
